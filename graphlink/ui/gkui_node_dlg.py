...
class GKUINodeEditDialog ( wx.Dialog ):   
    def __init__( self, parent, node):
        ...
        self.m_desc_ctrl = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 250,100 ), wx.TE_MULTILINE )
        fgSizer1.Add( self.m_desc_ctrl, 1, wx.ALL|wx.EXPAND, 5 )
        
        
        bSizer4.Add( fgSizer1, 1, wx.EXPAND, 5 )
        
        m_style_ctrlChoices = [ u"Diamond", u"Box" ]
        self.m_style_ctrl = wx.RadioBox( self, wx.ID_ANY, u"Style", wx.DefaultPosition, wx.DefaultSize, GK_SHAPE_TYPE, 1, wx.RA_SPECIFY_COLS )
        ...
        self.m_img_ctrl = wx.FilePickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE )
        ...
        bSizer4.Add( m_buttons_ctrl, 0, wx.EXPAND, 5 )
