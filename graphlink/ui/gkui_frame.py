...
class GKUIFrame (wx.Frame):
    ...
    def __init__(self, parent=None):
        ...
        self.m_menu_node_import = wx.MenuItem( self.m_menu_nodes, wx.ID_ANY, u"Import...", wx.EmptyString, wx.ITEM_NORMAL )
        self.m_menu_nodes.Append( self.m_menu_node_import )
        
        self.m_menu_node_add = wx.MenuItem( self.m_menu_nodes, wx.ID_ANY, u"Add...", wx.EmptyString, wx.ITEM_NORMAL )
        ...
        # Connect Events
        self.Bind( wx.EVT_MENU, self.OnNodeImport, id = self.m_menu_node_import.GetId() )
